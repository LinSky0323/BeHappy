    ...
    return ( 
      <BookingListProviders>
            ...
            <Parallax pages={w>800?2:4} style={{overflow:"auto"}} id="scrollContainer">
              ...
              <ParallaxLayer id="bookinglist_list" offset={0} speed={0} style={{display:"flex",justifyContent:"center",zIndex:"10"}}>
              {children}
              </ParallaxLayer>
              ...
              <ParallaxLayer id="bookinglist_record" offset={w>800?1:2} speed={0} style={{display:"flex",justifyContent:"center",zIndex:"10"}}>
              {record}
              </ParallaxLayer>
            </Parallax>
