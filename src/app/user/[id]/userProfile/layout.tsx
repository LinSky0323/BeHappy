    ...
    return ( 
      <ProfileProviders>
            ...
            <Parallax pages={2} style={{overflow:"auto"}} id="scrollContainer">
              ...
              <ParallaxLayer data-index={0} id="userProfile_profile" offset={0} speed={0} style={{display:"flex",justifyContent:"center",zIndex:"10"}}>
              {children}
              </ParallaxLayer>
              ...
              <ParallaxLayer data-index={1} id="userProfile_acount" offset={1} speed={0} style={{display:"flex",justifyContent:"center",zIndex:"10"}}>
              {acount}
              </ParallaxLayer>
            </Parallax>
